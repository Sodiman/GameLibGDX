package com.mygdx.game.framework.math;
...
public class OverlapTester {
    ...
    public static boolean overlapCircleRectatangle(Circle c, Rectangle r) {
        ...
        return c.center.distSquared(closetX, closetY) < c.radius * c.radius;
    }
