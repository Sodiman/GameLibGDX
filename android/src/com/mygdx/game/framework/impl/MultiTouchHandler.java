...
import com.mygdx.game.framework.Pool;
import com.mygdx.game.framework.impl.TouchHandler;
        ...
        synchronized (this) {
            ...
            for (int i = 0; i < MAX_TOUCHPOINTS; i++) {
                ...
                if (event.getAction() != MotionEvent.ACTION_MOVE && i != pointerIndex) {
                    // jika ini adalah event atas/bawah/cancel/keluar , id akan ditutup agar seharusnya proses terlihat disentuh
                    continue;
                }
                switch (action) {
